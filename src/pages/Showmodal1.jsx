...
function Shopmodal({ count, setCount }) {
      ...
      <section className="text-gray-600 body-font overflow-hidden py-10">
        <div className="container max-w-[70%] m-auto flex gap-10 max-sm:block max-sm:max-w-[98%]">
          ...
          <div className="lg:w-4/5 mx-auto flex my-auto flex-wrap">
            <div className="lg:w-1/1 w-full lg:px-6 lg:py-6 mt-6 lg:mt-0 max-sm:p-4">
              ...
              <div className="flex mt-[50px]">
                <span className="title-font font-medium text-3xl text-blue-500 max-sm:text-[21px]">
                  {product.price}$
                </span>
                <button onClick={() => handleCart(product)} class="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded max-sm:px-[5px] max-sm:text-[15px] max-sm:py-2">
