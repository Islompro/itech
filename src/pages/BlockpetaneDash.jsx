...
function BlockpetaneDash() {
    ...
    useEffect(() => {
        let data = collection(db, 'Blockpetane')
    ...
    const database = collection(db, "Blockpetane")
    ...
    const cartDelete = async (id) => {
        const deletePost = doc(db, "Blockpetane", id);
    ...
    const cartUpdate = async () => {
        const updateData = doc(db, 'Blockpetane', id);
            ...
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Quvvat manbalari</h1>
                    </div>
...
export default BlockpetaneDash
