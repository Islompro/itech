...
function Ups({ count, setCount }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const dataRef = collection(db, "Ups");
                    ...
                    <div className="flex">
                        ...
                        <div className="w-[100%]">
                            <div className="flex p-2 justify-between">
                                <LuPcCase className="text-blue-500 text-[35px] mt-2.5" />
                                <h1 className="text-[28px] font-normal p-1.5">UPS:</h1>
                                {show ? (
                                                    ...
                                                    <div className="max-sm:w-[100%] h-[auto] max-sm:h-[auto]">
                                                        ...
                                                        <div className="max-sm:w-[100%] p-5 h-auto max-sm:p-2">
                                                            ...
                                                            <div className="flex justify-between">
                                                                ...
                                                                <b className="bg-blue-500 p-1 text-[15px] cursor-pointer rounded-md text-white mt-[20px]" onClick={() => handleCart(game)}><NavLink to="/savat">Sotib olis</NavLink></b>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
