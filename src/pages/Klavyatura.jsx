...
function Klavayatura({ count, setCount }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const dataRef = collection(db, "keyboard");
                    ...
                    <div className="flex">
                        ...
                        <div className="w-[100%]">
                            <div className="flex p-2 justify-between">
                                <LiaKeyboardSolid className="text-blue-500 text-[35px] mt-2.5" />
                                <h1 className="text-[28px] font-normal p-1.5">Klaviaturalar:</h1>
                                {show ? (
                                                ...
                                                <div className="border-[1px] max-sm:m-0 rounded max-sm:rounded">
                                                    <div className="max-sm:w-[100%] h-[auto] max-sm:h-[auto]">
                                                        ...
                                                        <div className="max-sm:w-[100%] p-5 h-auto max-sm:p-2">
                                                            ...
                                                            <h2 className="text-gray-900 title-font font-medium max-sm:text-[15px] max-sm:w-[100%] max-sm:mb-[-5px]">
                                                                {game.title}
                                                            </h2>
                                                            <br />
