...
function GlassesDash() {
    ...
    useEffect(() => {
        let data = collection(db, 'glasses')
    ...
    const database = collection(db, "glasses")
    ...
    const cartDelete = async (id) => {
        const deletePost = doc(db, "glasses", id);
    ...
    const cartUpdate = async () => {
        const updateData = doc(db, 'glasses', id);
            ...
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Ko'zoynaklar</h1>
                    </div>
