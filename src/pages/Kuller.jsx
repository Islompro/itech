...
function Kuller({ count, setCount }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const dataRef = collection(db, "kuller");
                    ...
                    <div className="flex">
                        ...
                        <div className="w-[100%]">
                            <div className="flex p-2 justify-between">
                                <GiIceBolt className="text-blue-500 text-[35px] mt-2.5" />
                                <h1 className="text-[28px] font-normal p-1.5">Kullerlar:</h1>
                                {show ? (
