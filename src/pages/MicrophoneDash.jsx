...
function MicrophoneDash() {
    ...
    useEffect(() => {
        let data = collection(db, 'microphone')
    ...
    const database = collection(db, "microphone")
    ...
    const cartDelete = async (id) => {
        const deletePost = doc(db, "microphone", id);
    ...
    const cartUpdate = async () => {
        const updateData = doc(db, 'microphone', id);
            ...
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Mikrofonlar</h1>
                    </div>
                                    ...
                                    return (
                                        <Fragment key={data.id}>
                                            <div className="mt-3 w-[100%] flex justify-between items-center mb-3">
                                                <img className="w-[10%] h-[100%]" name="img" id="img" src={data.img} alt="" />
