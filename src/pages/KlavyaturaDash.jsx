...
function KlavyaturaDash() {
    ...
    useEffect(() => {
        let data = collection(db, 'keyboard')
    ...
    const database = collection(db, "keyboard")
    ...
    const cartDelete = async (id) => {
        const deletePost = doc(db, "keyboard", id);
    ...
    const cartUpdate = async () => {
        const updateData = doc(db, 'keyboard', id);
            ...
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Klaviaturalar</h1>
                    </div>
                                    ...
                                    return (
                                        <Fragment key={data.id}>
                                            <div className="mt-3 w-[100%] flex justify-between items-center mb-3 max-sm:mx-1">
                                                ...
                                                <b className="w-[10%] ml-[-9%] text-center max-sm:text-[10px] max-sm:ml-[-1%]" name="nameprodust" id="nameprodust">{data.title}</b>
