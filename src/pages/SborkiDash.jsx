...
function SborkiDash() {
    ...
    const database = collection(db, "uyin")
    ...
    const cartDelete = async (id) => {
        const deletePost = doc(db, "uyin", id);
    ...
    const cartUpdate = async () => {
        const updateData = doc(db, 'uyin', id);
            ...
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Oʻyin tuzilmalari</h1>
                    </div>
                                    ...
                                    return (
                                        <Fragment key={data.id}>
                                            <div className="mt-3 w-[100%] flex justify-between items-center mb-3 max-sm:mx-1">
                                                ...
                                                <p className="text-[20px] ml-[-6%] max-sm:text-[12px] max-sm:ml-[5%]" name="price" id="price">{data.price} $</p>
