...
function AccessoryDash() {
    ...
    useEffect(() => {
        let data = collection(db, 'accessory')
    ...
    const database = collection(db, "accessory")
    ...
    const cartDelete = async (id) => {
        const deletePost = doc(db, "accessory", id);
    ...
    const cartUpdate = async () => {
        const updateData = doc(db, 'accessory', id);
            ...
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Aksessuarlar</h1>
                    </div>
                                    ...
                                    return (
                                        <Fragment key={data.id}>
                                            <div className="mt-3 w-[100%] flex justify-between items-center mb-3 max-sm:mx-1">
                                                ...
                                                <b className="w-[10%] ml-[-11%] text-center max-sm:ml-[-2%] text-[10px]" name="nameprodust" id="nameprodust">{data.title}</b>
                                                <p className="text-[20px] ml-[-4%] max-sm:ml-[2%] max-sm:text-[12px]" name="price" id="price">{data.price} $</p>
