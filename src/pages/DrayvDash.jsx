...
function DrayvDash() {
    ...
    const database = collection(db, "drayv")
    ...
    const cartDelete = async (id) => {
        const deletePost = doc(db, "drayv", id);
    ...
    const cartUpdate = async () => {
        const updateData = doc(db, 'drayv', id);
            ...
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Drayvlar</h1>
                    </div>
