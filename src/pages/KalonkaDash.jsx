...
function KalonkaDash() {
    ...
    useEffect(() => {
        let data = collection(db, 'kalonka')
    ...
    const database = collection(db, "kalonka")
    ...
    const cartDelete = async (id) => {
        const deletePost = doc(db, "kalonka", id);
    ...
    const cartUpdate = async () => {
        const updateData = doc(db, 'kalonka', id);
            ...
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Kalonkalar</h1>
                    </div>
                                    ...
                                    return (
                                        <Fragment key={data.id}>
                                            <div className="mt-3 w-[100%] flex justify-between items-center mb-3 max-sm:mx-1">
                                                ...
                                                <div className="w-16 text-[15px] text-center flex items-center justify-center max-sm:mx-1">
